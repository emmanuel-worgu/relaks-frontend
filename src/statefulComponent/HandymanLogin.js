...
const HandymanLogin = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Relaks Technician Login | Login to see your Dashboard</title>
        ...
        <meta name="keywords" content="relaks technician login, relaks technician, relaks home inc, relaks home inc, cheap home service in nigeria, home repairs in nigeria, home care in nigeria, how to get my home repaired in nigeria, where to find electrician in nigeria, where to find a plumber in nigeria" />
      </Helmet>
      <LoginForm
